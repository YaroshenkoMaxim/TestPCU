...
public class ContextKNU5076 {
	...
	public By getContextName() {
		return By.xpath("//div[contains(@class,'slick-active')]/div/div[@class='context-descr']/div[text()='Бей-Беги. История футбола.']");
	}
	
	public By getContextButton() {
		return By.xpath("//div[contains(@class,'slick-active')]/div/div[@class='context-descr']/div[text()='Бей-Беги. История футбола.']/following::a[1]");
	}
	*/
}
